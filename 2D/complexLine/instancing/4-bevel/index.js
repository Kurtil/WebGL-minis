...
import joinVertexShaderSource from "./shaders/bevel/vertex.js";
import joinFragmentShaderSource from "./shaders/bevel/fragment.js";
...
/** pseudo geometry used as coefficient use to index the bevel basis vectors
...
gl.drawArraysInstanced(
  gl.TRIANGLES,
  0,
  bevelJoinInstanceGeometry.length / 2,
  path.length / 2 - 2
);
